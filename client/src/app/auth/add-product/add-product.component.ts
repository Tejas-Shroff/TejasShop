  ...
  ngOnInit(): void {}
    constructor(private fb: FormBuilder, public authservcie: AuthService, public notification : NotificationService) {
      this.addProductForm = this.fb.group({
        ...
        discountPercentage: ['', [this.nonNegativeValidator, Validators.max(100)]]
      });
    }
    ...
    onSubmit() {
      ...
      if (this.addProductForm.invalid) {
        this.notification.Error('Form is invalid. Please fill out all required fields.');
        return;
      }
      ...
      formData.append('discountPercentage', this.addProductForm.get('discountPercentage')?.value);
